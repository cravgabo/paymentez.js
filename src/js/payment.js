...
Payment.SERVER_DEV_URL = "https://ccapi-dev.clickpayredeban.com";
Payment.SERVER_STG_URL = "https://ccapi-stg.clickpayredeban.com";
Payment.SERVER_QA_URL = "https://ccapi-qa.clickpayredeban.com";
Payment.SERVER_PROD_URL = "https://ccapi.clickpayredeban.com";

Payment.PG_MICROS_STAGING = "https://pg-micros-stg.clickpayredeban.com/v1/unixtime/";
Payment.PG_MICROS_PRODUCTION = "https://pg-micros.clickpayredeban.com/v1/unixtime/";
  ...
  let initFunction = function () {
    ...
    xmlhttp.setRequestHeader(
      ...
      Payment.getAuthToken(
        Payment.PAYMENTEZ_CLIENT_APP_CODE,
        Payment.PAYMENTEZ_CLIENT_APP_KEY
      )
    );
...
Payment.setEnvironment = function (
  ...
  Payment.PAYMENTEZ_CLIENT_APP_CODE = paymentez_client_app_code;
  Payment.PAYMENTEZ_CLIENT_APP_KEY = paymentez_client_app_key;
};
